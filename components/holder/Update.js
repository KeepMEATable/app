...
import { success } from '../../actions/holder/create';
import { retrieve, update, reset } from '../../actions/holder/update';
import { loading, error } from '../../actions/holder/delete';
...
const mapStateToProps = state => ({
  retrieveError: state.holder.update.retrieveError,
  retrieveLoading: state.holder.update.retrieveLoading,
  updateError: state.holder.update.updateError,
  updateLoading: state.holder.update.updateLoading,
  created: state.holder.create.created,
  deleted: state.holder.del.deleted,
  retrieved: state.holder.update.retrieved,
  updated: state.holder.update.updated,
});
